...
- F102/F103 и входной ключ выбираются по реальному пусковому току, температуре меди и допустимому падению напряжения.
...
| Q101 | 1 | защита от переполюсовки | Vishay SiSS5623DN, P-channel 60 V | PowerPAK SO-8 / по drawing | VERIFY | Проверить RDS(on) при доступном VGS, SOA при 25 A и рассеяние на 4 слоях. |
| D101 | 1 | TVS входа | SMBJ18A-E3/52 | SMB | CANDIDATE | TVS не заменяет fuse; проверить совместно с БП и проводом. |
| D102 | 1 | ограничение |VGS| Q101 | MMSZ5242B-7-F, 12 V zener | SOD-323 | CANDIDATE | Проверить ток через R102 и импульс при подключении БП. |
| F101 | 1 | общий входной предохранитель | Bourns SF-2923HC-C series, 25 A variant | 2920 / 7451 | VERIFY | Утвердить конкретный part number и I²t; вариант зависит от источника 300 W. |
| F102 | 1 | ветвь PTC/pump/fans | SF-2923HC-C series, 15–20 A variant | 2920 / 7451 | VERIFY | 20 A — стартовое значение, согласовать с кабелем и пуском PTC. |
| F103 | 1 | ветвь LED boost | SF-2923HC-C series, 10 A variant | 2920 / 7451 | VERIFY | 10 A — стартовое значение; селективность относительно F101 проверить. |
...
| J101 | 1 | 2-pin power terminal, ≥25 A | 5.08 mm, exact family VERIFY | VERIFY | Phoenix MKDS-1,5 footprint пока только кандидат; для 25 A может понадобиться более крупный connector. |
...
1. Заказать/получить фактические MPN Q101, F101–F103, Q711/Q721/Q731, D711/D721/D731 и дросселей из доступного поставщика.
2. Сверить реальные посадочные места по drawings: Q101 и boost MOSFET, PSMC диоды, дроссели 13.5×12.5 mm, входной и силовые клеммники.
